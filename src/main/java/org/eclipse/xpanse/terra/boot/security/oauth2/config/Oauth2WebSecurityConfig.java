...
package org.eclipse.xpanse.terra.boot.security.oauth2.config;

import static org.eclipse.xpanse.terra.boot.security.oauth2.config.Oauth2Constants.AUTH_TYPE_JWT;
import static org.eclipse.xpanse.terra.boot.security.oauth2.config.Oauth2Constants.AUTH_TYPE_TOKEN;
...
import org.eclipse.xpanse.terra.boot.security.oauth2.introspector.OauthOpaqueTokenIntrospector;
...
public class Oauth2WebSecurityConfig {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        ...
        http.securityMatcher("/terra-boot/**");
        http.authorizeHttpRequests(
                arc -> {
                    arc.requestMatchers("/terra-boot/**").authenticated();
